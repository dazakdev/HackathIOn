      ...
      <aside className="w-[340px] border-r border-border flex flex-col items-center py-10 px-8 bg-card/30">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-10">
          <div className="relative">
            <div
              className={`absolute -top-12 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-xl px-6 py-3 text-sm font-bold shadow-2xl animate-bounce ${isVictory ? "bg-green-500 text-white" : "bg-red-500 text-white"}`}
            >
              {isVictory ? "UDAŁO SIĘ!" : "NASTĘPNYM RAZEM!"}
              <div
                className={`absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-full w-0 h-0 border-l-[8px] border-l-transparent border-r-[8px] border-r-transparent border-t-[8px] ${isVictory ? "border-t-green-500" : "border-t-red-500"}`}
              />
            </div>
            <img
