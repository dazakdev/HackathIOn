  ...
  return (
    <div className="mx-auto max-w-[1200px] h-[calc(100vh-8rem)] rounded-3xl overflow-hidden border border-white/10 bg-[#2f2f2f] shadow-[0_30px_80px_rgba(0,0,0,0.4)] flex flex-col">
      <div className="h-12 bg-[#3b3b3b] flex items-center px-6 text-xs text-white/80">
        ...
        <div className="rounded-full bg-white/10 px-3 py-1 text-xs font-semibold">12,450 XP</div>
      </div>
      ...
      <div className="flex-1 grid md:grid-cols-[280px_1fr]">
        <aside className="border-r border-white/10 flex flex-col items-center justify-center gap-6 p-6">
          <div className="rounded-2xl bg-white text-black px-6 py-3 text-sm font-semibold shadow-lg text-center">
        ...
        <div className="flex flex-col items-center justify-center px-10 py-8 text-white">
          ...
          <div className="w-full max-w-2xl rounded-2xl bg-black/30 border border-white/10 p-8 text-center">
            <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-6">
              <div className="space-y-3">
                <div className="mx-auto size-16 rounded-full border-2 border-white/60" />
          ...
          <div className="mt-6 w-full max-w-2xl grid md:grid-cols-[1.3fr_0.7fr] gap-6">
            ...
            <div className="rounded-2xl bg-black/30 border border-white/10 p-6 text-center">
              ...
              <div className="mt-4 size-20 rounded-full border-4 border-white/20 flex items-center justify-center mx-auto">
