...
import { Clock3, Loader2, Swords, Zap } from "lucide-react"
      ...
      <aside className="w-[340px] border-r border-border flex flex-col items-center py-10 px-8 bg-card/30">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-10">
          ...
          <div className="text-center space-y-2">
            <h3 className="text-foreground font-bold italic">
              "Muszę aktywować więcej neuronów!"
            </h3>
            <p className="text-muted-foreground text-xs px-4">
              Twój uczeń właśnie staje oko w oko z potężnym przeciwnikiem.
            </p>
          </div>
        </div>
          ...
          <div className="w-full max-w-4xl space-y-12 relative z-10">
            <div className="flex items-center justify-between">
              <div className="space-y-2">
                <span className="inline-flex items-center rounded-md bg-red-500/80 px-4 py-1 text-[10px] font-black text-white uppercase tracking-widest">
                  HARD MODE
                </span>
              ...
              <div className="text-right">
                ...
                <p className="text-xl font-black text-red-500 animate-pulse">
                  AGRESYWNY
                </p>
              </div>
            </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-black/40 flex flex-col justify-end p-8">
                  <div className="flex items-center gap-4 mb-2">
                    <div className="h-3 flex-1 bg-white/10 rounded-full overflow-hidden border border-white/10">
                      <div
                        className="h-full bg-red-500 animate-[shimmer_2s_infinite] shadow-[0_0_20px_rgba(239,68,68,0.8)]"
                        style={{ width: "100%" }}
                      />
                    </div>
